 ...
 */
public class WebPersonPageActivity extends AppCompatActivity {
    WebView mWebView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_person_page);
        ...
        mWebView = (WebView) findViewById(R.id.webPersonView);
    ...
    private void openURL() {
        mWebView.loadUrl(PersonExtendAdapter.webPersonPAGE);
